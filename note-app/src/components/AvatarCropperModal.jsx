    ...
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm sm:p-6">
      <div className="flex w-full max-w-md flex-col overflow-hidden rounded-[2rem] bg-white shadow-2xl">
        <div className="border-b border-slate-200 px-6 py-5">
          <h2 className="text-xl font-bold text-slate-900">Profil Fotoğrafı Önizleme</h2>
          <p className="mt-1 text-sm text-slate-500">Seçtiğiniz fotoğrafı onaylayın.</p>
        </div>
        
        <div className="relative flex h-[300px] w-full items-center justify-center bg-slate-100 p-4 sm:h-[350px]">
          <img
            src={imageSrc}
            alt="Önizleme"
